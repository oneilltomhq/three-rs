...
/// `HemisphereLightNode.setup()`: a sky/ground mix by the world normal's
/// hemisphere weight, added straight into the lighting context's `irradiance`.
pub fn hemisphere_light(index: usize, out: &mut Vec<NodeRef>) {
