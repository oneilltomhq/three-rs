...
var<private> VERTEX_nodeVar29 : vec4<f32>;
...
fn main( @location( 0 ) position : vec3<f32> ) -> VaryingsStruct {
	...
	VERTEX_nodeVar29 = ( render.cameraProjectionMatrix * vec4<f32>( varyings.v_positionView, 1.0 ) );
	VERTEX_v_modelViewProjection = VERTEX_nodeVar29;
