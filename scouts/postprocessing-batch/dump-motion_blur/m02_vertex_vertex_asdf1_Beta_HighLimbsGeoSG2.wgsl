...
struct NodeBuffer_1386Struct {
	value : array< mat4x4<f32>, 67 >
};
@binding( 6 ) @group( 1 )
var<uniform> NodeBuffer_1386 : NodeBuffer_1386Struct;
...
var<private> VERTEX_nodeVar183 : vec4<f32>;
...
fn main( @location( 0 ) position : vec3<f32>,
	...
	varyings.positionLocal = ( object.nodeUniform0 * ( ( ( ( ( skinWeight.x * NodeBuffer_1386.value[ skinIndex.x ] ) * nodeVar1 ) + ( ( skinWeight.y * NodeBuffer_1386.value[ skinIndex.y ] ) * nodeVar1 ) ) + ( ( skinWeight.z * NodeBuffer_1386.value[ skinIndex.z ] ) * nodeVar1 ) ) + ( ( skinWeight.w * NodeBuffer_1386.value[ skinIndex.w ] ) * nodeVar1 ) ) ).xyz;
	normalLocal = normal;
	normalLocal = ( mat3x3<f32>( ( ( object.nodeUniform0 * ( ( ( skinWeight.x * NodeBuffer_1386.value[ skinIndex.x ] + skinWeight.y * NodeBuffer_1386.value[ skinIndex.y ] ) + skinWeight.z * NodeBuffer_1386.value[ skinIndex.z ] ) + skinWeight.w * NodeBuffer_1386.value[ skinIndex.w ] ) ) * object.nodeUniform2 )[ 0 ].xyz, ( ( object.nodeUniform0 * ( ( ( skinWeight.x * NodeBuffer_1386.value[ skinIndex.x ] + skinWeight.y * NodeBuffer_1386.value[ skinIndex.y ] ) + skinWeight.z * NodeBuffer_1386.value[ skinIndex.z ] ) + skinWeight.w * NodeBuffer_1386.value[ skinIndex.w ] ) ) * object.nodeUniform2 )[ 1 ].xyz, ( ( object.nodeUniform0 * ( ( ( skinWeight.x * NodeBuffer_1386.value[ skinIndex.x ] + skinWeight.y * NodeBuffer_1386.value[ skinIndex.y ] ) + skinWeight.z * NodeBuffer_1386.value[ skinIndex.z ] ) + skinWeight.w * NodeBuffer_1386.value[ skinIndex.w ] ) ) * object.nodeUniform2 )[ 2 ].xyz ) * normalLocal );
	...
	VERTEX_nodeVar183 = ( render.cameraProjectionMatrix * vec4<f32>( varyings.v_positionView, 1.0 ) );
	VERTEX_v_modelViewProjection = VERTEX_nodeVar183;
