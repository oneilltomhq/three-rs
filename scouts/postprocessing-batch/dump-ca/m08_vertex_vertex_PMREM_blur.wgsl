...
var<private> VERTEX_nodeVar23 : vec4<f32>;
...
fn main( @location( 0 ) outputDirection : vec3<f32>,
	...
	VERTEX_nodeVar23 = ( render.cameraProjectionMatrix * vec4<f32>( v_positionView, 1.0 ) );
	VERTEX_v_modelViewProjection = VERTEX_nodeVar23;
