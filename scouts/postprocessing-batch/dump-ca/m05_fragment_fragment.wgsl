...
fn main( @location( 0 ) v_positionView : vec3<f32>,
	...
	nodeVar2 = textureSample( nodeUniform9, nodeUniform9_sampler, vec2<f32>( Roughness, clamp( nodeVar1, 0.0, 1.0 ) ) ).xy;
	let dfg = nodeVar2;
	...
	nodeVar9 = ( render.nodeUniform11 - v_positionView );
	...
	if ( ( render.nodeUniform13 > 0.0 ) ) {
		...
		nodeVar14 = ( nodeVar13 / render.nodeUniform13 );
		nodeVar15 = clamp( ( 1.0 - ( ( ( nodeVar14 * nodeVar14 ) * nodeVar14 ) * nodeVar14 ) ), 0.0, 1.0 );
		nodeVar12 = ( ( 1.0 / max( pow( nodeVar13, render.nodeUniform14 ), 0.01 ) ) * ( nodeVar15 * nodeVar15 ) );

	} else {

		nodeVar12 = ( 1.0 / max( pow( length( nodeVar9 ), render.nodeUniform14 ), 0.01 ) );

	}

	nodeVar16 = ( render.nodeUniform12 * vec3<f32>( nodeVar12 ) );
