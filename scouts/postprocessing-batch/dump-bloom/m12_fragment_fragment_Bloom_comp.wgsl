...
struct NodeBuffer_1191Struct {
	value : array< vec4<f32>, 5 >
};
@binding( 1 ) @group( 0 )
var<uniform> NodeBuffer_1191 : NodeBuffer_1191Struct;
...
fn main( @location( 0 ) nodeVarying0 : vec2<f32> ) -> OutputStruct {
	...
	output.color = ( ( ( ( ( ( ( vec4<f32>( fn4( nodeVar0[ 0u ], object.nodeUniform0 ) ) * vec4<f32>( NodeBuffer_1191.value[ 0u ].xyz, 1.0 ) ) * nodeVar1 ) + ( ( vec4<f32>( fn4( nodeVar0[ 1u ], object.nodeUniform0 ) ) * vec4<f32>( NodeBuffer_1191.value[ 1u ].xyz, 1.0 ) ) * nodeVar2 ) ) + ( ( vec4<f32>( fn4( nodeVar0[ 2u ], object.nodeUniform0 ) ) * vec4<f32>( NodeBuffer_1191.value[ 2u ].xyz, 1.0 ) ) * nodeVar3 ) ) + ( ( vec4<f32>( fn4( nodeVar0[ 3u ], object.nodeUniform0 ) ) * vec4<f32>( NodeBuffer_1191.value[ 3u ].xyz, 1.0 ) ) * nodeVar4 ) ) + ( ( vec4<f32>( fn4( nodeVar0[ 4u ], object.nodeUniform0 ) ) * vec4<f32>( NodeBuffer_1191.value[ 4u ].xyz, 1.0 ) ) * nodeVar5 ) ) * vec4<f32>( object.nodeUniform12 ) );
