...
struct NodeBuffer_1156Struct {
	value : array< mat4x4<f32>, 120 >
};
@binding( 3 ) @group( 1 )
var<uniform> NodeBuffer_1156 : NodeBuffer_1156Struct;
...
struct VaryingsStruct {
	...
	@location( 3 ) vInstanceColor : vec3<f32>,
...
var<private> VERTEX_nodeVar196 : vec4<f32>;
...
fn main( @builtin( instance_index ) instanceIndex : u32,
	...
	positionLocal = ( NodeBuffer_1156.value[ instanceIndex ] * vec4<f32>( positionLocal, 1.0 ) ).xyz;
	normalLocal = normal;
	normalLocal = normalize( ( transpose( tsl_inverse_mat3( mat3x3<f32>( NodeBuffer_1156.value[ instanceIndex ][ 0 ].xyz, NodeBuffer_1156.value[ instanceIndex ][ 1 ].xyz, NodeBuffer_1156.value[ instanceIndex ][ 2 ].xyz ) ) ) * normalLocal ) );
	...
	VERTEX_nodeVar196 = ( render.cameraProjectionMatrix * vec4<f32>( varyings.v_positionView, 1.0 ) );
	VERTEX_v_modelViewProjection = VERTEX_nodeVar196;
