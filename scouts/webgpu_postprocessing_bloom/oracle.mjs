// Dumps Three's own GLTFLoader parse of PrimaryIonDrive.glb as a JSON oracle.
// Run:  node oracle.mjs > primaryiondrive.json
// No GPU, no network. Paths are absolute to the vendor tree (r186).
import fs from 'fs';
...
const FILE = '/home/tom/src/vendor/three.js/examples/models/gltf/PrimaryIonDrive.glb';
