...
var<private> VERTEX_nodeVar136 : vec4<f32>;
...
fn main( @location( 0 ) color : vec4<f32>,
	...
	VERTEX_nodeVar136 = ( render.cameraProjectionMatrix * vec4<f32>( varyings.v_positionView, 1.0 ) );
	VERTEX_v_modelViewProjection = VERTEX_nodeVar136;
